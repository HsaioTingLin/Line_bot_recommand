...
from recipe_system import apriori_simplification_revised,recipe_recommend_function_redis
...
class ReplyMessager(object):
    ...
    ingredient_tmp = json.load(open('素材/ingredient_reply/reply.json','r',encoding="utf-8"))
